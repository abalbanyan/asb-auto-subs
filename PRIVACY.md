...
The Jimaku API key is used only to authenticate requests to Jimaku so the extension can search for and download subtitle files. The extension may also contact AniList to resolve anime IDs and supported anime streaming pages to detect the current anime title and episode.
